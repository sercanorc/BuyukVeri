...
(50 p) Kısım 1 (Apache Spark Uygulaması Gelistirme)
...
2- Çözüm kernelini yayınlamak ve kernel linkini gonderilecek olan raporda paylasmak
...
4- Gelistirdiginiz çözümü, asagıdaki alt baslıkları içerecek ¸sekilde IEEE A4 formatında ˘
